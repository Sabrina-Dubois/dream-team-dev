  ...
  validations() {
    return {
      firstName: {
        ...
        maxLengthValue: helpers.withMessage(() => this.$t('validations.firstName.maxLength'), maxLength(5))
      },
      lastName: {
        maxLengthValue: helpers.withMessage(() => this.$t('validations.lastName.maxLength'), maxLength(5))
      },
      technicalTopic: {
        maxLengthValue: helpers.withMessage(() => this.$t('validations.technicalTopic.maxLength'), maxLength(5))
      }
    }
  }
}
          ...
          <div class="row align-items-center">
            <div class="col-sm-6 align-items-center">
              ...
              <span v-if="v$.firstName.$error">
                <span v-for="error in v$.firstName.$errors" :key="error.$message" class="text-danger">{{
                  error.$message
                }}</span>
              </span>
            </div>
            <div class="col-sm-6 align-items-center">
              ...
              <span v-if="v$.lastName.$error">
                <span v-for="error in v$.lastName.$errors" :key="error.$message" class="text-danger">{{
                  error.$message
                }}</span>
              </span>
            </div>
          ...
          <div class="row align-items-center mt-4">
            <div class="col-sm-6 align-items-center">
              ...
              <span v-if="v$.technicalTopic.$error">
                <span v-for="error in v$.technicalTopic.$errors" :key="error.$message" class="text-danger">{{
                  error.$message
                }}</span>
              </span>
            </div>
